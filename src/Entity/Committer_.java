...
public class Committer_ implements Serializable
{
    ...
    private final static long serialVersionUID = 758493303061715687L;
     ...
     * @param nodeId
     */
    public Committer_(String login, int id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, boolean siteAdmin) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
    ...
    public Committer_ withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public Committer_ withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
